...
const supportsUserTiming = enableProfilerTimer &&
...
export function logComponentRender(
  ...
  if (supportsUserTiming) {
    ...
    const color = selfTime < 0.5
      ? wasHydrated ? "tertiary-light" : "primary-light"
      : selfTime < 10
      ? wasHydrated ? "tertiary" : "primary"
      : selfTime < 100
      ? wasHydrated ? "tertiary-dark" : "primary-dark"
      : "error";
    ...
    if (!__DEV__) {
      ...
      if (
        ...
        const properties = [resuableChangedPropsEntry];
      ...
      const options = {
        ...
        detail: {
          devtools: {
            color: "error",
            track: COMPONENTS_TRACK,
            tooltipText: fiber.tag === SuspenseComponent
              ? "Hydration failed"
