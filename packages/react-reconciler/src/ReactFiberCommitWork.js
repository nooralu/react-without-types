...
function commitBeforeMutationEffects_begin(isViewTransitionEligible) {
  ...
  while (nextEffect !== null) {
    ...
    if (enableViewTransition && fiber.tag === OffscreenComponent) {
      const isModernRoot = disableLegacyMode ||
    ...
    case FunctionComponent: {
      if (enableUseEffectEventHook) {
        if ((flags & Update) !== NoFlags) {
          ...
          const eventPayloads = updateQueue !== null
            ? updateQueue.events
            : null;
  ...
  switch (finishedWork.tag) {
    ...
    case OffscreenComponent: {
      ...
      if (isModernRoot) {
        ...
        const newOffscreenSubtreeIsHidden = isHidden ||
        ...
        if (newOffscreenSubtreeIsHidden) {
          ...
          const newOffscreenSubtreeWasHidden = wasHidden ||
  ...
  switch (finishedWork.tag) {
    ...
    case HostHoistable: {
      if (supportsResources) {
        ...
        if (flags & Update) {
          const currentResource = current !== null
    ...
    case SuspenseComponent: {
      ...
      if (offscreenFiber.flags & Visibility) {
        ...
        const wasShowingFallback = current !== null &&
          (current.memoizedState) !== null;
    ...
    case ViewTransitionComponent: {
      if (enableViewTransition) {
        ...
        inUpdateViewTransition = isViewTransitionEligible &&
...
function commitPassiveMountOnFiber(
  ...
  switch (finishedWork.tag) {
    ...
    case HostRoot: {
      ...
      if (enableProfilerTimer && enableComponentPerformanceTrack) {
        ...
        inHydratedSubtree = finishedWork.alternate !== null &&
    ...
    case ActivityComponent: {
      const wasInHydratedSubtree = inHydratedSubtree;
      if (enableProfilerTimer && enableComponentPerformanceTrack) {
        const prevState = finishedWork.alternate !== null
  ...
  if (
    ...
    const isMount = !inHydratedSubtree &&
      finishedWork.alternate === null &&
      finishedWork.return !== null &&
      finishedWork.return.alternate !== null;
    if (isMount) {
