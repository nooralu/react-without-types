  ...
  if (ownerID === null) {
    switch (action.type) {
      ...
      case "SELECT_ELEMENT_BY_ID":
        ...
        inspectedElementIndex = inspectedElementID === null
          ? null
        ...
        if (inspectedElementIndex !== null) {
          ...
          if (selectedElement !== null && selectedElement.parentID !== 0) {
            ...
            if (parent !== null) {
              ...
              const nextChildID = selectedChildIndex < children.length - 1
        ...
        if (inspectedElementIndex !== null) {
          ...
          if (selectedElement !== null && selectedElement.parentID !== 0) {
            ...
            if (parent !== null) {
              const { children } = parent;
              const selectedChildIndex = children.indexOf(selectedElement.id);
              const nextChildID = selectedChildIndex > 0
                ? children[selectedChildIndex - 1]
      ...
      case "SELECT_PREVIOUS_ELEMENT_WITH_ERROR_OR_WARNING_IN_TREE": {
        const elementIndicesWithErrorsOrWarnings = store
        ...
        let prevEntry;
        if (flatIndex === 0) {
          prevEntry = elementIndicesWithErrorsOrWarnings[
...
function getInitialState({
  ...
  return {
    ...
    inspectedElementID: defaultInspectedElementID != null
      ? defaultInspectedElementID
      : store.lastSelectedHostInstanceElementId,
    inspectedElementIndex: defaultInspectedElementIndex != null
      ? defaultInspectedElementIndex
      : store.lastSelectedHostInstanceElementId
...
export { TreeContextController, TreeDispatcherContext, TreeStateContext };
