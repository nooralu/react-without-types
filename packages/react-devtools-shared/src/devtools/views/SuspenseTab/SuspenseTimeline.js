...
function SuspenseTimelineInput() {
  ...
  function switchSuspenseNode(nextTimelineIndex) {
  ...
  function handleChange(pendingTimelineIndex) {
  ...
  function handleHoverSegment(hoveredValue) {
  ...
  function changeTimelineIndex(newIndex) {
...
export default function SuspenseTimeline() {
