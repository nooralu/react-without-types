...
const TransitionUpdateLanes = TransitionLane1 |
  TransitionLane2 |
  TransitionLane3 |
  TransitionLane4 |
  TransitionLane5 |
  ...
  TransitionLane9 |
  TransitionLane10;
const TransitionDeferredLanes = TransitionLane11 | TransitionLane12 |
  TransitionLane13 | TransitionLane14;
...
export const UpdateLanes = SyncLane | InputContinuousLane | DefaultLane |
  TransitionUpdateLanes;

export const HydrationLanes = SyncHydrationLane |
...
export function getNextLanesToFlushSync(
  ...
  const unblockedLanesWithMatchingPriority = unblockedLanes &
...
export function includesBlockingLane(lanes) {
  const SyncDefaultLanes = SyncHydrationLane |
    SyncLane |
    InputContinuousHydrationLane |
    InputContinuousLane |
    DefaultHydrationLane |
...
export function markRootFinished(
  ...
  if (
    ...
    const freshlySpawnedRetryLanes = suspendedRetryLanes &
