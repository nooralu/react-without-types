...
describe("parseHookNames", () => {
  ...
  beforeEach(() => {
    ...
    const parseSourceAndMetadata =
      require("../parseHookNames/parseSourceAndMetadata")
  ...
  it("should parse names for useReducer()", async () => {
    const Component =
      require("./__source__/__untransformed__/ComponentWithUseReducer")
        .Component;
    const hookNames = await getHookNamesForComponent(Component);
  ...
  it("should skip loading source files for unnamed hooks like useEffect", async () => {
    const Component =
      require("./__source__/__untransformed__/ComponentWithUseEffect")
        .Component;
  ...
  it("should skip loading source files for unnamed hooks like useEffect (alternate)", async () => {
    const Component =
      require("./__source__/__untransformed__/ComponentWithExternalUseEffect")
        .Component;
  ...
  it("should parse names for custom hooks", async () => {
    const Component =
      require("./__source__/__untransformed__/ComponentWithNamedCustomHooks")
        .Component;
    const hookNames = await getHookNamesForComponent(Component);
  ...
  it("should parse names for code using hooks indirectly", async () => {
    const Component =
      require("./__source__/__untransformed__/ComponentUsingHooksIndirectly")
        .Component;
    const hookNames = await getHookNamesForComponent(Component);
  ...
  it("should parse names for code using nested hooks", async () => {
    const Component =
      require("./__source__/__untransformed__/ComponentWithNestedHooks")
        .Component;
    let InnerComponent;
    const hookNames = await getHookNamesForComponent(Component, {
  ...
  it("should return null for custom hooks without explicit names", async () => {
    const Component =
      require("./__source__/__untransformed__/ComponentWithUnnamedCustomHooks")
        .Component;
    const hookNames = await getHookNamesForComponent(Component);
    expectHookNamesToEqual(hookNames, [
