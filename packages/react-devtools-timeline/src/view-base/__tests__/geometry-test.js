...
describe("sizeEqualToSize", () => {
  it("should return true when 2 sizes have the same values", () => {
    expect(sizeEqualToSize({ width: 1, height: 1 }, { width: 1, height: 1 }))
      .toBe(
        true,
      );
    expect(
  ...
  it("should return false when 2 sizes have different values", () => {
    expect(sizeEqualToSize({ width: 1, height: 1 }, { width: 1, height: 0 }))
      .toBe(
        false,
      );
    expect(sizeEqualToSize({ width: -1, height: 2 }, { width: 0, height: 1 }))
      .toBe(
        false,
      );
    expect(
