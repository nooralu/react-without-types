...
export function renderToString() {
  return require("./src/server/ReactDOMLegacyServerBrowser").renderToString
    .apply(
      this,
      arguments,
    );
...
export function renderToStaticMarkup() {
  return require("./src/server/ReactDOMLegacyServerBrowser")
...
export function renderToReadableStream() {
  return require("./src/server/react-dom-server.browser").renderToReadableStream
    .apply(
      this,
      arguments,
    );
