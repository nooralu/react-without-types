...
export function installHook(
  ...
  profilingSettings = defaultProfilingSettings,
) {
    ...
    for (const method of consoleMethodsToOverrideForErrorsAndWarnings) {
      ...
      const overrideMethod = (...args) => {
        ...
        if (settings.appendComponentStack) {
          ...
          alreadyHasComponentStack = typeof lastArg === "string" &&
            isStringComponentStack(lastArg); // The last argument should be a component stack.
        }
