...
export function createFragmentInstance(fiber) {
  return null;
}

export function updateFragmentInstanceFiber(fiber, instance) {
  // Noop
}
...
export function deleteChildFromFragmentInstance(child, fragmentInstance) {
  // Noop
}
