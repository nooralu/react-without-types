...
export function CallSiteView({
  ...
  const symbolicatedCallSite = fetchFileWithCaching !== null
    ? use(
  ...
  const [functionName, url, line, column] = symbolicatedCallSite !== null
    ? symbolicatedCallSite.location
    : callSite;
  const ignored = symbolicatedCallSite !== null
    ? symbolicatedCallSite.ignored
    : false;
  if (ignored) {
