...
export default class ReactFlightWebpackPlugin {
  ...
  constructor(options) {
    ...
    this.clientManifestFilename = options.clientManifestFilename ||
        ...
        function () {
          ...
          compilation.chunkGroups.forEach(function (chunkGroup) {
            ...
            chunkGroup.chunks.forEach(function (chunk) {
              const chunkModules = compilation.chunkGraph
        ...
        contextResolver.resolve(
          ...
          (err, resolvedDirectory) => {
            ...
            const options = {
              ...
              resourceQuery: "",
              recursive: clientReferenceSearch.recursive === undefined
                ? true
