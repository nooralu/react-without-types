...
function updateOffscreenComponent(
  ...
  if (
    ...
    if (didSuspend) {
      ...
      const nextBaseLanes = prevState !== null
...
function getRemainingWorkInPrimaryTree(
  ...
  let remainingLanes = current !== null
  ...
  if (current === null) {
    ...
    if (showFallback) {
      ...
      const prevOffscreenState = current.child
        .memoizedState;
      primaryChildFragment.memoizedState = prevOffscreenState === null
        ...
        if (currentTransitions !== null) {
          ...
          if (offscreenQueue === null) {
            ...
            const newOffscreenQueue = {
              transitions: currentTransitions,
              markerInstances: parentMarkerInstances,
              retryQueue: currentOffscreenQueue !== null
  ...
  if (!didSuspend) {
    ...
    if (isSuspenseInstanceFallback(suspenseInstance)) {
      ...
      if (__DEV__) {
        ...
        ({ digest } = getSuspenseInstanceFallbackErrorDetails(
          suspenseInstance,
        ));
      }
...
function updateSuspenseListComponent(
  ...
  if (!shouldForceFallback) {
    const didSuspendBefore = current !== null &&
...
function updateViewTransition(
  ...
  if (pendingProps.name != null && pendingProps.name !== "auto") {
    ...
    workInProgress.flags |= current === null
  ...
  if (__DEV__) {
    ...
    if (pendingProps.className !== undefined) {
      const example = typeof pendingProps.className === "string"
