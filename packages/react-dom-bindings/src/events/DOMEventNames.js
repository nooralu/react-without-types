...
export const TRANSITION_RUN = getVendorPrefixedEventName("transitionrun");
export const TRANSITION_START = getVendorPrefixedEventName("transitionstart");
export const TRANSITION_CANCEL = getVendorPrefixedEventName("transitioncancel");
