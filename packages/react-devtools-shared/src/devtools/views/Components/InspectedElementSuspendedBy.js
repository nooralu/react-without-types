...
function getShortDescription(name, description) {
...
function SuspendedByRow({
  ...
  const showAwaitStack = canShowAwaitStack &&
    (!showIOStack ||
      (ioOwner === null
        ? asyncOwner !== null
  ...
  const metaName = value !== null && typeof value === "object"
    ? value[meta.name]
    : null;
      ...
      {isOpen && (
        <div className={styles.CollapsableContent}>
          {showIOStack && (
            <StackTraceView
              stack={ioInfo.stack}
              environmentName={ioOwner !== null && ioOwner.env === ioInfo.env
                ? null
                : ioInfo.env}
            />
          )}
          {ioOwner !== null &&
            ...
            ? (
              <OwnerView
                ...
                environmentName={ioOwner.env === inspectedElement.env &&
              ...
              <>
                ...
                {asyncInfo.stack !== null && asyncInfo.stack.length > 0 && (
                  <StackTraceView
                    ...
                    environmentName={asyncOwner !== null &&
