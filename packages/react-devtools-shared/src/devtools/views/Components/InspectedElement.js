...
export default function InspectedElementWrapper(_) {
  ...
  const source = inspectedElement == null
    ? null
  ...
  const symbolicatedSourcePromise = React.useMemo(() => {
  ...
  const isSuspended = element !== null &&
    element.type === ElementTypeSuspense &&
    inspectedElement != null &&
    inspectedElement.isSuspended;

  const canToggleError = !hideToggleErrorAction &&
    inspectedElement != null &&
    inspectedElement.canToggleError;

  const canToggleSuspense = !hideToggleSuspenseAction &&
    inspectedElement != null &&
    ...
    >
      <div className={styles.TitleRow} data-testname="InspectedElement-Title">
        ...
        <div className={styles.SelectedComponentName}>
          <div
            className={element.isStrictModeNonCompliant
