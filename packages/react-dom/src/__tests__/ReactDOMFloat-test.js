...
describe("ReactDOMFloat", () => {
  ...
  function loadPreloads(hrefs) {
    ...
    resolveLoadables(
      ...
      nodes,
      event,
      (href) => Scheduler.log("load preload: " + href),
    );
  }
  ...
  function errorPreloads(hrefs) {
    ...
    resolveLoadables(
      ...
      nodes,
      event,
      (href) => Scheduler.log("error preload: " + href),
    );
  }
  ...
  describe("ReactDOM.preloadModule(href, options)", () => {
    it("preloads scripts as modules", async () => {
      function App({ ssr }) {
        ...
        ReactDOM.preloadModule(prefix + "integrity", {
          integrity: "some hash",
        });
        ReactDOM.preloadModule(prefix + "serviceworker", {
          as: "serviceworker",
        });
        return <div>hello</div>;
      }
  ...
  describe("ReactDOM.preinitModule(href, options)", () => {
    it("creates a script module resources", async () => {
      function App({ ssr }) {
        ...
        ReactDOM.preinitModule(prefix + "integrity", {
          integrity: "some hash",
        });
