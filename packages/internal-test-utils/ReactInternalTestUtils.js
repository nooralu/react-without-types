...
import { actingUpdatesScopeDepth, thrownErrors } from "./internalAct";
...
export async function waitForThrow(expectedError) {
...
export async function unstable_waitForExpired(expectedLog) {
