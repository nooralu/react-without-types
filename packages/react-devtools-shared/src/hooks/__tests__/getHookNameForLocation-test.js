...
export function Component() {
  ...
  return a + b + c + d + e + f.current;
    ...
    expect(getHookNameForLocation({ line: 1, column: 0 }, hookMap)).toEqual(
      null,
    );
    expect(getHookNameForLocation({ line: 2, column: 25 }, hookMap)).toEqual(
      null,
    );
    expect(getHookNameForLocation({ line: 5, column: 12 }, hookMap)).toEqual(
      "a",
    );
    expect(getHookNameForLocation({ line: 5, column: 13 }, hookMap)).toEqual(
      "a",
    );
    ...
    expect(getHookNameForLocation({ line: 6, column: 20 }, hookMap)).toEqual(
      "b",
    );
    ...
    expect(getHookNameForLocation({ line: 9, column: 12 }, hookMap)).toEqual(
      "c",
    );
    expect(getHookNameForLocation({ line: 9, column: 13 }, hookMap)).toEqual(
      "c",
    );
    ...
    expect(getHookNameForLocation({ line: 9, column: 31 }, hookMap)).toEqual(
      "d",
    );
    expect(getHookNameForLocation({ line: 9, column: 32 }, hookMap)).toEqual(
      "d",
    );
...
export function Component() {
  ...
  return null;
    ...
    expect(getHookNameForLocation({ line: 9, column: 4 }, hookMap)).toEqual(
      null,
    );
  });
...
export function Component() {
  ...
  return val;
    ...
    expect(getHookNameForLocation({ line: 8, column: 2 }, hookMap)).toEqual(
      null,
    );
  });
});
