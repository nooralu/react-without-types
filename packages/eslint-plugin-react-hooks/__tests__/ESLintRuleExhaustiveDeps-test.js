...
const tests = {
  ...
  invalid: [
      ...
      errors: [
        {
          ...
          suggestions: [
            {
              desc:
                "Update the dependencies array to be: [dispatch3, dispatch4, state7, state8]",
              output: normalizeIndent`
                function ComponentUsingFormState(props) {
                  const [state7, dispatch3] = useFormState();
                  const [state8, dispatch4] = ReactDOM.useFormState();
    ...
    },
    {
      ...
      errors: [
        {
          message: "React Hook useEffect requires an effect callback. " +
        ...
        {
          message: "React Hook useCallback requires an effect callback. " +
            "Did you forget to pass a callback to the hook?",
          suggestions: undefined,
        },
        {
          message: "React Hook useMemo requires an effect callback. " +
            "Did you forget to pass a callback to the hook?",
          suggestions: undefined,
        },
      ],
  ...
  invalid: [
    {
      ...
      errors: [
        {
          message: "React Hook useEffect has a missing dependency: 'a'. " +
            "Either include it or remove the dependency array.",
          suggestions: [
            {
...
if (!process.env.CI) {
  ...
  testsTypescriptEslintParserV4.valid = testsTypescriptEslintParserV4.valid
    .filter(predicate);
  testsTypescriptEslintParserV4.invalid = testsTypescriptEslintParserV4.invalid
    .filter(predicate);
}
