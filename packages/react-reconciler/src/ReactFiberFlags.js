...
export const LifecycleEffectMask = Passive | Update | Callback | Ref |
  Snapshot | StoreConsistency;

// Union of all commit flags (flags with the lifetime of a particular commit)
export const HostEffectMask =
  /*               */ 0b0000000000000000111111111111111;
...
export const ViewTransitionStatic =
...
export const BeforeAndAfterMutationTransitionMask = Snapshot | Update |
  Placement | ChildDeletion | Visibility | ContentReset;
...
export const StaticMask = LayoutStatic |
  PassiveStatic |
  RefStatic |
  MaySuspendCommit |
