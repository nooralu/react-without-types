const chromeManifest = require(
  "../react-devtools-extensions/chrome/manifest.json",
);
const firefoxManifest = require(
  "../react-devtools-extensions/firefox/manifest.json",
);
