...
describe("ReactFlightDOMReply", () => {
  ...
  it("can pass two independent FormData with same keys", async () => {
    ...
    const { a: formDataA2, b: formDataB2 } = await ReactServerDOMServer
      .decodeReply(body, webpackServerMap);
  ...
  it("can pass JSX through a round trip using temporary references", async () => {
    ...
    const temporaryReferences = ReactServerDOMClient
    ...
    const temporaryReferencesServer = ReactServerDOMServer
      .createTemporaryReferenceSet();
