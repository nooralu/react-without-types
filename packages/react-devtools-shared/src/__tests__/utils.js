...
export function getActDOMImplementation() {
...
export function getActTestRendererImplementation() {
  // This is for React < 17, where act wasn't shipped yet.
  if (semver.lt(requestedReactVersion, "17.0.0")) {
...
export function getLegacyRenderImplementation() {
  let ReactDOM;
  let container;
...
export function getModernRenderImplementation() {
  let ReactDOMClient;
  let container;
  let root;
  const containersToRemove = [];
...
export const getVersionedRenderImplementation =
