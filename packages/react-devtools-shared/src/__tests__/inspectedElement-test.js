...
describe("InspectedElement", () => {
  ...
  beforeEach(() => {
    ...
    InspectedElementContext = require(
      "react-devtools-shared/src/devtools/views/Components/InspectedElementContext",
    ).InspectedElementContext;
    InspectedElementContextController = require(
      "react-devtools-shared/src/devtools/views/Components/InspectedElementContext",
    ).InspectedElementContextController;
    SettingsContextController = require(
      "react-devtools-shared/src/devtools/views/Settings/SettingsContext",
    ).SettingsContextController;
    StoreContext =
      require("react-devtools-shared/src/devtools/views/context").StoreContext;
    TreeContextController =
      require("react-devtools-shared/src/devtools/views/Components/TreeContext")
        .TreeContextController;
    TreeStateContext =
      require("react-devtools-shared/src/devtools/views/Components/TreeContext")
        .TreeStateContext;
