...
function createChildReconciler(
  ...
  function reconcileChildrenIteratable(
    ...
    if (__DEV__) {
      if (newChildren === newChildrenIterable) {
        ...
        // as needed.
        const isGeneratorComponent = returnFiber.tag === FunctionComponent &&
          // $FlowFixMe[method-unbinding]
  ...
  function reconcileChildFibersImpl(
    ...
    const isUnkeyedUnrefedTopLevelFragment = typeof newChild === "object" &&
      newChild !== null &&
...
function validateSuspenseListNestedChild(childSlot, index) {
  if (__DEV__) {
    ...
    const isIterable = !isAnArray &&
      typeof getIteratorFn(childSlot) === "function";
    const isAsyncIterable = enableAsyncIterableChildren &&
