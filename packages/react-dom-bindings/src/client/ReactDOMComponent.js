...
function normalizeHTML(parent, html) {
  if (__DEV__) {
    ...
    const testElement = parent.namespaceURI === MATH_NAMESPACE ||
...
function setProp(
  ...
  switch (key) {
    ...
    case "multiple": {
      domElement.multiple = value && typeof value !== "function" &&
        typeof value !== "symbol";
      break;
    }
    case "muted": {
      domElement.muted = value && typeof value !== "function" &&
        typeof value !== "symbol";
      break;
    }
