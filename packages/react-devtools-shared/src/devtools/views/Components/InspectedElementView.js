...
export default function InspectedElementView({
  ...
  const rendererLabel = rendererPackageName !== null && rendererVersion !== null
  ...
  const showRenderedBy = showStack || showOwnersList ||
    rendererLabel !== null || rootType !== null;
                ...
                owners?.map((owner) => (
                  <Fragment key={owner.id}>
                    <OwnerView
                      ...
                      environmentName={inspectedElement.env === owner.env
                        ? null
                        : owner.env}
