      ...
      switch (thenable.status) {
        case "fulfilled": {
          ...
          hookLog.push({
            ...
            debugInfo: thenable._debugInfo === undefined
              ? null
              : thenable._debugInfo,
...
const DispatcherProxy = typeof Proxy === "undefined"
  ? Dispatcher
...
function buildTree(
  ...
  for (let i = 0; i < readHookLog.length; i++) {
    ...
    if (stack !== null) {
      ...
      for (let j = stack.length - commonSteps - 1; j >= 1; j--) {
        ...
        const levelChild = {
          ...
          debugInfo: null,
          hookSource: {
            lineNumber: stackFrame.lineNumber === undefined
              ? null
              : stackFrame.lineNumber,
            columnNumber: stackFrame.columnNumber === undefined
              ? null
              : stackFrame.columnNumber,
            functionName: stackFrame.functionName === undefined
              ? null
              : stackFrame.functionName,
            fileName: stackFrame.fileName === undefined
              ? null
              : stackFrame.fileName,
          },
        };
    ...
    if (stack && stack.length >= 1) {
      ...
      hookSource.lineNumber = stackFrame.lineNumber === undefined
        ? null
        : stackFrame.lineNumber;
      hookSource.functionName = stackFrame.functionName === undefined
        ? null
        : stackFrame.functionName;
      hookSource.fileName = stackFrame.fileName === undefined
        ? null
        : stackFrame.fileName;
      hookSource.columnNumber = stackFrame.columnNumber === undefined
        ? null
        : stackFrame.columnNumber;
    }
...
export function inspectHooks(
  ...
  const rootStack = ancestorStackError === undefined
    ? []
...
export function inspectHooksOfFiber(
  ...
  if (hasOwnProperty.call(currentFiber, "dependencies")) {
    ...
    currentContextDependency = dependencies !== null
    ...
    currentContextDependency = contextDependencies !== null
