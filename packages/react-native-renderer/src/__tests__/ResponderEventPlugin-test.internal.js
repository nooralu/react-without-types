...
describe("ResponderEventPlugin", () => {
  beforeEach(() => {
    ...
    EventBatching = require(
      "react-native-renderer/src/legacy-events/EventBatching",
    );
    EventPluginUtils = require(
      "react-native-renderer/src/legacy-events/EventPluginUtils",
    );
    ResponderEventPlugin =
      require("react-native-renderer/src/legacy-events/ResponderEventPlugin")
        .default;
  ...
  it(
    ...
    async () => {
      ...
      const ReactDOMComponentTree = require(
