...
export function getAlwaysOpenInEditor() {
  try {
...
export function getIsReloadAndProfileSupported() {
...
export function getIfReloadedAndProfiling() {
  return (
    sessionStorageGetItem(SESSION_STORAGE_RELOAD_AND_PROFILE_KEY) === "true"
  );
}

export function getProfilingSettings() {
  return {
...
export function onReloadAndProfileFlagsReset() {
