...
export class NetworkMeasuresView extends View {
  ...
  _drawSingleNetworkMeasure(
    ...
    const timestampEnd = finishTimestamp || lastReceivedDataTimestamp ||
      duration;
    const timestampMiddle = receiveResponseTimestamp ||
      firstReceivedDataTimestamp || timestampEnd;
    ...
    if (rectIntersectsRect(rect, visibleArea)) {
      context.beginPath();
      context.fillStyle = this._hoveredNetworkMeasure === networkMeasure
    ...
    const durationLabel = finishTimestamp !== 0
