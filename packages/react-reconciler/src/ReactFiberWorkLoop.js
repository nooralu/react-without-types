...
function finishConcurrentRender(
  ...
  if (shouldForceFlushFallbacksInDEV()) {
    ...
    if (
      ...
      const msUntilTimeout = globalMostRecentFallbackTime +
...
function handleThrow(root, thrownValue) {
  ...
  if (
    ...
    const isWakeable = thrownValue !== null &&
  ...
  if (enableProfilerTimer && enableComponentPerformanceTrack) {
    if (__DEV__) {
      if (workInProgressUpdateTask === null) {
        ...
        workInProgressUpdateTask = fiber._debugTask == null
          ? null
          : fiber._debugTask;
      }
    }
...
function replayBeginWork(unitOfWork) {
  ...
  let next;
  const isProfilingMode = enableProfilerTimer &&
...
function commitRoot(
  ...
  if (enableProfilerTimer && enableComponentPerformanceTrack) {
    ...
    if (exitStatus === RootErrored) {
      ...
      const hydrationFailed = finishedWork !== null &&
      ...
      switch (fiber.tag) {
        ...
        case SimpleMemoComponent: {
          ...
          if (!didWarnAboutUpdateInRenderForAnotherComponent.has(dedupeKey)) {
            ...
            const setStateComponentName = getComponentNameFromFiber(fiber) ||
              "Unknown";
            console.error(
